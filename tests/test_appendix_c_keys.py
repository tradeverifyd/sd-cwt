...
class TestAppendixCKeys:
    ...
    def test_thumbprint_computation_es256_holder(self, es256_holder_public_key_edn):
        ...
        ), f"Expected {expected_thumbprint.hex()}, got {thumbprint.hex()}"
    ...
    def test_cbor_roundtrip_all_keys(
        self, es256_holder_private_key_edn, es384_issuer_private_key_edn
    ):
    ...
    def test_key_validation_required_fields(
        self, es256_holder_private_key_edn, es384_issuer_private_key_edn
    ):
    ...
    def test_extract_public_keys_from_private(
        self, es256_holder_private_key_edn, es384_issuer_private_key_edn
    ):
    ...
    def test_algorithm_curve_consistency(
        self, es256_holder_private_key_edn, es384_issuer_private_key_edn
    ):
    ...
    def test_specification_algorithm_corrections(
        self, es256_holder_private_key_edn, es384_issuer_private_key_edn
    ):
    ...
    def test_interoperability_export_formats(
        self, es256_holder_private_key_edn, es384_issuer_private_key_edn
    ):
    ...
    def test_edn_format_specification_compliance(
        self, es256_holder_private_key_edn, es384_issuer_private_key_edn
    ):
